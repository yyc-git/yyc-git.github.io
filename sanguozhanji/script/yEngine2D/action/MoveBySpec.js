    ...
    describe("update", function () {
        ...
        describe("否则", function () {
            ...
            it("计算精灵在本次更新中移动的距离，并更新精灵坐标", function () {
                ...
                expect(fakeTarget.setPositionX.calledWith(1 + ratio * 50)).toBeTruthy();
                expect(fakeTarget.setPositionY.calledWith(2 + ratio * 100)).toBeTruthy();
            });
