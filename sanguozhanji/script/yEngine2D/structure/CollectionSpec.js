    ...
    describe("remove", function () {
        describe("如果第一个参数为function", function () {
            ...
            it("删除成功返回true，失败返回false", function () {
                ...
                expect(collection.remove(function (e) {
                    return e === 1;
                })).toBeTruthy();
                expect(collection.remove(function (e) {
                    return e === 1;
        ...
        describe("如果第一个参数为引擎实体类", function () {
            ...
            it("删除成功返回true，失败返回false", function () {
                ...
                expect(collection.remove(child)).toBeTruthy();
                expect(collection.remove(child)).toBeFalsy();
            });
        });
        ...
        describe("否则", function () {
            ...
            it("删除成功返回true，失败返回false", function () {
                ...
                expect(collection.remove(1)).toBeTruthy();
                expect(collection.remove(1)).toBeFalsy();
            });
        });
