describe("Sequence", function () {
    ...
    describe("initWhenCreate", function () {
        ...
        it("加入内部动作", function () {
            ...
            sandbox.stub(action.ye____actions, "addChilds");

            action.initWhenCreate(actionArr);

            expect(action.ye____actions.addChilds.calledWith(actionArr)).toBeTruthy();
        });
        it("获得当前动作", function () {
    ...
    describe("update", function () {
        ...
        describe("否则", function () {
            ...
            it("根据动作序号，获得当前执行的动作", function () {
                ...
                expect(action.ye____actions.getChildAt.calledWith(0)).toBeTruthy();
            });
...
//    });
    ...
    describe("copy", function () {
        it("返回动作副本，拷贝内部动作", function () {
            ...
            expect(YE.Sequence.create.calledWith(copyAction1, copyAction2)).toBeTruthy();
        });
    });
